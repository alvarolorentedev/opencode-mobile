  ...
  return (
    <Card mode="contained" style={[styles.card, { backgroundColor: palette.surface }]}> 
      <Card.Content style={styles.section}>
        ...
        <SettingSwitchRow description="Keep the transcript pinned to the newest message. Disable to read older messages while the assistant is still streaming." onValueChange={(value) => updateChatPreferences({ autoScrollToBottom: value })} palette={palette} title="Auto-scroll to newest" value={chatPreferences.autoScrollToBottom} />
